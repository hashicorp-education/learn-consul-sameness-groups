...
kubectl config rename-context gke_$(terraform -chdir=dc2-gcloud output -raw project)_ $(terraform -chdir=dc2-gcloud output -raw zone)_learn-consul-sameness-dc2 dc2
...
## Follow the instructions, name the cluster `learn-consul-sameness-dc2` until the CLI commands step
...
## Set learn-consul-sameness-dc1 as the Peering Acceptor
